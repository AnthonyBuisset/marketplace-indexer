...
pub enum Error {
	...
	CreateIndexer { id: String, details: String },
	#[error("unable to get the indexer `{id}`: {details}")]
	GetIndexer { id: String, details: String },
	#[error("unable to delete the indexer `{id}`: {details}")]
	DeleteIndexer { id: String, details: String },
}
...
mod test {
	...
	#[rstest]
	#[case(Error::CreateIndexer{id: String::from("ID"), details: String::from("details")}, "unable to create the indexer `ID`: details")]
	#[case(Error::GetIndexer{id: String::from("ID"), details: String::from("details")}, "unable to get the indexer `ID`: details")]
	#[case(Error::DeleteIndexer{id: String::from("ID"), details: String::from("details")}, "unable to delete the indexer `ID`: details")]
